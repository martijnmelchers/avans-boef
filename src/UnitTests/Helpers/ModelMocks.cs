...
namespace UnitTests.Helpers
{
    public class ModelMocks
    {
        ...
        public ModelMocks()
        {
            ...
            {
                new Models.Accessoire { Id = 1, Name = "Banaan", Price = 3 },
                new Models.Accessoire { Id = 2, Name = "Zadel", Price = 50 },
                new Models.Accessoire { Id = 3, Name = "Krukje", Price = 60 },
                new Models.Accessoire { Id = 4, Name = "Zweep", Price = 20 },
                new Models.Accessoire { Id = 5, Name = "Bal", Price = 10 },
                new Models.Accessoire { Id = 6, Name = "Dansschoenen", Price = 200 },
            };
            ...
            Beestjes = new List<Beestje>
            {
                ...
                new Beestje
                {
                    Id = 2, Name = "Olifant", Type = Type.Jungle, Price = 200,
                },
                new Beestje
                {
                ...
                new Beestje
                {
                    Id = 6, Name = "Ezel", Type = Type.Boerderij, Price = 200,
                },
                new Beestje
                {
                    Id = 7, Name = "Koe", Type = Type.Boerderij, Price = 200,
                },
                new Beestje
                {
                    Id = 8, Name = "Eend", Type = Type.Boerderij, Price = 200,
                },
                new Beestje
                {
                    Id = 9, Name = "Kuiken", Type = Type.Boerderij, Price = 200,
                },
                new Beestje
                {
                ...
                new Beestje
                {
                    Id = 11, Name = "Ijsbeer", Type = Type.Sneeuw, Price = 200
                },
                new Beestje
                {
                ...
                new Beestje
                {
                    Id = 13, Name = "Kameel", Type = Type.Woestijn, Price = 200,
                },
                new Beestje
                {
                    Id = 14, Name = "Slang", Type = Type.Woestijn, Price = 200,
                },
                new Beestje
                {
                    Id = 15, Name = "abcdefghijklmnopqrstuvwxyz", Type = Type.Woestijn, Price = 200,
                },

                new Beestje
                {
                    Id = 16, Name = "Eend", Type = Type.Boerderij, Price = 220,
                },

                new Beestje
                {
                    Id = 17, Name = "Penguin 1", Type = Type.Sneeuw, Price = 200,
                },
                new Beestje
                {
                    Id = 18, Name = "Penguin 2", Type = Type.Sneeuw, Price = 200,
                },
                new Beestje
                {
                    Id = 19, Name = "Penguin 3", Type = Type.Sneeuw, Price = 200,
                },
            };
